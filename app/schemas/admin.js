...
adminSchema.pre('save',function(next){
    ...
    bcrypt.genSalt(10,function(err,salt){
        if(err){
             ...
             * 第二个参数是hash后生成的值
             */
            bcrypt.hash(admin.password,salt,function(err,hashresult){
                if(err){
                    return next(err);
                }else{
                    /*
...
/*
 * 通过module.exports将adminSchema对外公开，
 * 这样外部就可以访问到adminSchema
 */
